...
async function loadAllProducts() {
  // FIXED: was /admin/products, now /admin/viewAllProduct
  const response = await fetch("/admin/viewAllProduct", {
    headers: {
      "Authorization": "Bearer " + getToken()
    }
  });
...
async function loadProductDetails() {
  ...
  // FIXED: was /admin/products/${id}, now /admin/viewProduct/${id}
  const response = await fetch(`/admin/viewProduct/${id}`, {
    headers: {
      "Authorization": "Bearer " + getToken()
    }
  });
...
async function updateProduct(event) {
  ...
  // FIXED: was /admin/products/${id}, now /admin/updateProduct/${id}
  const response = await fetch(`/admin/updateProduct/${id}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
      "Authorization": "Bearer " + getToken()
...
async function deleteProduct(id) {
  ...
  // FIXED: was /admin/products/${id}, now /admin/deleteProduct/${id}
