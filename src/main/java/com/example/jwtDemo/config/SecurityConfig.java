        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers(
                    ...
                    "/admin-home.html", "/product-management.html",
                    "/add-product.html", "/update-product.html",
                    "/delete-product.html", "/search-product.html",
                ...
                .requestMatchers("/api/products/**").permitAll()   // <-- PUBLIC: anyone can browse products
